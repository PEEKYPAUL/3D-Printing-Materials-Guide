...
![Heat-set inserts installed in a printed part](../images/inserts-01-installed.jpg)
...
![Soldering iron pressing insert into printed hole](../images/inserts-02-install.jpg)
*Light pressure with the iron — let the heat do the work. Flush or just below the surface is the target.*

![Correctly installed insert flush with print surface](../images/inserts-03-flush.jpg)
