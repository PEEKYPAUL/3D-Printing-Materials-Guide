...
| Problem | Fix |
|---|---|
| Warping/lifting | Enclose printer, raise bed temp, add brim |
| Layer separation | Reduce cooling, raise nozzle temp |
| Stringing | Tune retraction and temperature |
| Poor bed adhesion | Use PEI or ASA slurry on glass |
